      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link href="#home" className={activelink === 'home' ? "active-navbar-link":"navbar-link anavbar"} onClick={()=>onUpdateActiveLink('home')}>Home</Nav.Link>
          ...
          <span className="navbar-text">
            <div className="social-icon">
                <a href="https://www.linkedin.com/in/somia-saad-404a91246/"> <img src={navIcon1} alt=""/></a>
