            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                <span className="tagline">Welcome to my Portfolio</span>
                  <h1>{`Hi! I'm Somia Saad`} <span className="txt-rotate" dataPeriod="1000" data-rotate={`[ "Web Developer", "Full stack", "Front-end and Back-end" ]`}><span className="wrap">{text}</span></span></h1>
